...
export const PUBLIC_NOTE_REQUEST = "PUBLIC_NOTE_REQUEST";
export const PUBLIC_NOTE_SUCCESS = "PUBLIC_NOTE_SUCCESS";
export const PUBLIC_NOTE_FAIL  = "PUBLIC_NOTE_FAIL";
